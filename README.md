...
- Добавлены четыре E2E-сценария в настоящем Chrome/Chromium: повторные ручные
  и автоматические исправления, защита нового выделения и сброс разрешения.
  Тесты запускаются в отдельном X11-сеансе без сети и пользовательского профиля.
